<!-- /.delete_record_modal Modal Start -->
<div class="modal modal-danger fade" id="delete_record_modal{{$item->id}}">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('purchase.store') }}" data-parsley-validate class="form-horizontal form-label-left"  >
                    ...
                    <input type="hidden" name="delete_record_id" value="{{ $item->id }}" class="form-control name_list" required/>
