<!-- /.add_quotation_item_modal Modal Start -->
<div class="modal modal-warning fade" id="add_quotation_item_modal">
                        ...
                        <tr>
                                <td width="100%">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                             <!--Size dropdown menu-->
                                            <select id="size_select" name="quotation_item_id" style=" color: #333; background-color: #fff; border-color: #ccc; padding: 6px 12px; margin-bottom: 0; font-size: 14px; font-weight: 400; line-height: 1.42857143; text-align: center; white-space: nowrap; vertical-align: middle; cursor: pointer; /* -webkit-user-select: none; */ -moz-user-select: none; -ms-user-select: none; user-select: none; background-image: none; border: 1px solid transparent; border-radius: 4px;">
                        ...
                        <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        @foreach($purchase_items as $items) 
                                        <div id="{{ $items->id }}" class="size_chart">
                                            <input type="text" name="quotation_actual_price" value="{{ round($items->unit_price + $items->gst, 0) }}" class="form-control name_list" disabled/>
                                        </div>
                                        @endforeach
                                        </div>
                                    </div>
                            ...
                            <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="quotation_quantity" class="form-control name_list" required/>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="quotation_price" class="form-control name_list" required/>
                                            </div>
                                        </div>
                                    </td>
                            </tr>
