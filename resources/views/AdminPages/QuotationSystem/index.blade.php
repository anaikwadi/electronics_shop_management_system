...
<form method="post" action="{{ route('quotation.store') }}" data-parsley-validate class="form-horizontal form-label-left"  >
    {{ csrf_field() }}
 ...
 <div class="row">
                        ...
                        <div class="col-md-12 text-left">
                            <address>
                                ...
                                <div class="row-fluid">
                                        ...
                                        <select name="quotation_item_customer_name" class="selectpicker" data-live-search="true" required>
                    ...
                    {{-- Search Custome End --}}                   
                            ...
                            {{-- <div class="col-md-12 text-left">
                                <address>
                                    ...
                                    <select name="quotation_item_payment_method" class="selectpicker" data-live-search="true" class="form-control" name="payment_method" required>
                                    ...
                                    <address>
                                        ...
                                        <input type="date" name="quotation_item_due_date" class="form-control name_list"/>
                                    </address>
                            </div> --}}
                    ...
                    <table class="table borderless">
                        ...
                        <tbody>
                            ...
                            @if($items->status == 0 && $items->item_id != 0)
                                <tr>
                                        ...
                                        <td> 
                                            ...
                                            <button type="button" style="margin-right: 5px;" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete_quotation_item_modal{{$items->id}}"> Delete</button>                           
                                            @endrole
                                        </td>
                                </tr>
                                {{-- @php $total_amt = $total_amt + $items->total;  $inc++; @endphp --}}
                                @endif
                            @endforeach
                            ...
                            <tfoot> 
                                <tr>
                                    <th colspan="5">
                                        <button type="button" style="margin-right: 5px;" class="btn btn-primary" data-toggle="modal" data-target="#add_quotation_item_modal"> + Add More</button>
                                    </th>
                                </tr>
                            </tfoot> 
                    </table>
    ...
    {{-- add_quotation_item_modal.blade include Start --}}
    @include('AdminPages.QuotationSystem.add_quotation_item_modal')
    {{-- add_quotation_item_modal.blade End --}}  


    @foreach($quotation_items as $items)
        {{-- delete_quotation_item_modal.blade include Start --}}
        @include('AdminPages.QuotationSystem.delete_quotation_item_modal')
        {{-- delete_quotation_item_modal.blade End --}}
    @endforeach
