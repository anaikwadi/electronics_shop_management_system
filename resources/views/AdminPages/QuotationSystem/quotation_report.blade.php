...
<table class="table" width="100%" border="1"  style="border-collapse: collapse;">
        ...
        <tr>
            <td>   Amount Paid in Words : <b> <font size="2"> {{ displaywords($last_bill_paid_bal_details->paid_amount) }} /- </font></b> </td>
            @if($last_bill_paid_bal_details->balance_amount != 0)
            <td>  Balance Amount in Words : <b> <font size="2"> {{ displaywords($last_bill_paid_bal_details->balance_amount) }} /- </font> </b> </td>
            @endif
        </tr>
    </table> --}}
